...
SECRET_KEY = '(uu6$bd2*j7d@6nw1i$5!d6-7#)4hno(3o4!rqi!#2-uu$qexp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['authproject-arun3q.c9users.io','0.0.0.0', 'localhost']
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': '/home/ubuntu/workspace/mysql_db_set.cnf',
        },
    }
}
